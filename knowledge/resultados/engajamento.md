...
type: result
title: Engajamento
description: O resultado esperado quando reconhecimento, escuta e comunicação humana são aplicados de forma consistente — pessoas que se importam com o trabalho porque se sentem importantes.
tags: [engajamento, motivação, pertencimento, resultado]
links:
...
- Pessoas trazem problemas cedo, em vez de esconder até virar crise.
- Iniciativa sem precisar ser pedida — porque há senso de dono, não de operário.
- Discordância aberta e construtiva, sinal de que é seguro pensar diferente.
- Queda de rotatividade: as pessoas ficam porque querem, não porque precisam.
...
- Vem do filtro: [reconhecimento.md](../filtros/reconhecimento.md)
- Vem da ação: [dando-feedback.md](../acoes/dando-feedback.md)
