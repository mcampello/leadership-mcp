...
A base é navegada em quatro camadas encadeadas:
...
Cada arquivo declara no frontmatter (`links:`) as conexões com as outras camadas — é assim
que o servidor MCP monta uma orientação consolidada a partir de uma situação descrita.

## Estrutura do Bundle

### /gatilhos
Situações relacionais que ativam sugestões comportamentais.
- [relacionamento.md](gatilhos/relacionamento.md) — interação com colega, gestor, subordinado
- [conflito.md](gatilhos/conflito.md) — tensão, discordância, ruptura
...
- [antes-da-reuniao.md](acoes/antes-da-reuniao.md)
- [durante-o-conflito.md](acoes/durante-o-conflito.md)
- [dando-feedback.md](acoes/dando-feedback.md)
- [recebendo-feedback.md](acoes/recebendo-feedback.md)
